...
Planned checks for this corrective slice:

1. `./.venv/bin/python -m pytest tests/test_retrieval.py -q`
2. `./.venv/bin/python -m ruff check contracts/ingestion.py contracts/__init__.py rag/ingestion.py tests/test_retrieval.py`
